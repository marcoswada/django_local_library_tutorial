...
class AuthorViewTest(TestCase):
    ...
    def setUpTestData(cls):
        # Create 13 authors for paginating tests
...
class LoanedBookInstanceByUserListViewTest(TestCase):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Check that now we have borrowed books on the list
        response = self.client.get(reverse('my-borrowed'))
        # Check ou user logged in
        self.assertEqual(str(response.context['user']), 'testuser1')
        # Check that we got a response  "Success"
        self.assertEqual(response.status_code, 200)
...
class RenewBookInstancesTest(TestCase):
    ...
    def test_HTTP404_for_invalid_book_if_logged_in(self):
        # unlikely UID to mamtch our bookinstance!
        test_uid = uuid.uuid4()
        login = self.client.login(username='testuser2', password = '2HJ1vRV0Z&3iD')
